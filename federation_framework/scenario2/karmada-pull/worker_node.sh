...
mv /root/edgesys-2025/federation_framework/scenario2/karmada-pull/metrics_server.yaml /root/
cp /root/edgesys-2025/federation_framework/scenario2/karmada-pull/node_list /root/
cp /root/edgesys-2025/federation_framework/scenario2/karmada-pull/patch.sh /root/
