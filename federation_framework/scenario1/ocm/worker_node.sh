...
mv /root/edgesys-2025/federation_framework/scenario1/ocm/metrics_server.yaml /root/
cp /root/edgesys-2025/federation_framework/scenario1/ocm/node_list /root/
cp /root/edgesys-2025/federation_framework/scenario1/ocm/patch.sh /root/
