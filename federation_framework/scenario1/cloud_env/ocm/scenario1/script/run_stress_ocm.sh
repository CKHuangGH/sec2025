...
for ip in $(cat node_exec); do 
  ssh -o LogLevel=ERROR root@$ip bash /root/sec2025/federation_framework/scenario1/ocm/scenario1/script/checking_svc.sh $SVC_THRESHOLD &
  ssh -o LogLevel=ERROR root@$ip bash /root/sec2025/federation_framework/scenario1/ocm/scenario1/script/checking_sa.sh $SA_THRESHOLD &
...
for ip in $(cat node_exec); do 
  ssh -o LogLevel=ERROR root@$ip python3 /root/sec2025/federation_framework/scenario1/ocm/scenario1/script/getmetrics_cpuram_time_member.py
done