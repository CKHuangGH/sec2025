...
for ip in $(cat node_exec); do 
  ssh root@$ip bash /root/sec2025/federation_framework/scenario1/ocm/scenario1/script/timesave.sh "start deployment"
done
...
for ip in $(cat node_exec); do 
  ssh -o LogLevel=ERROR root@$ip bash /root/sec2025/federation_framework/scenario1/ocm/scenario1/script/checking_pod.sh $POD_THRESHOLD
done
...
for ip in $(cat node_exec); do 
  ...
  ssh root@$ip bash /root/sec2025/federation_framework/scenario1/ocm/scenario1/script/timesave.sh "calc cpuram average time"
  ssh -o LogLevel=ERROR root@$ip python3 /root/sec2025/federation_framework/scenario1/ocm/scenario1/script/getmetrics_cpuram_average10_member.py #ok
  sleep 2

  ssh root@$ip bash /root/sec2025/federation_framework/scenario1/ocm/scenario1/script/timesave.sh "calc member k8s api time"
  ssh -o LogLevel=ERROR root@$ip python3 /root/sec2025/federation_framework/scenario1/ocm/scenario1/script/getmetrics_latency_average10.py #ok
  sleep 2

  ssh root@$ip bash /root/sec2025/federation_framework/scenario1/ocm/scenario1/script/timesave.sh "calc member k8s controller time"
  ssh -o LogLevel=ERROR root@$ip python3 /root/sec2025/federation_framework/scenario1/ocm/scenario1/script/getmetrics_controller_average10.py #ok
  sleep 2
done
