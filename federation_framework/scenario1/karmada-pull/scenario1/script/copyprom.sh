...
scp -o StrictHostKeyChecking=no -r /root/prom-$number-member/ chuang@172.16.207.100:/home/chuang/results$number-$time-karmada-pull-member
scp -o StrictHostKeyChecking=no -r /root/prom-$number/ chuang@172.16.207.100:/home/chuang/results$number-$time-karmada-pull