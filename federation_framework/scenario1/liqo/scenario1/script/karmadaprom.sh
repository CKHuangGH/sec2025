...
SECRET_FILE="/root/sec2025/federation_framework/scenario1/liqo/scenario1/script/secret.yaml"
...
VALUES_FILE="/root/sec2025/federation_framework/scenario1/liqo/scenario1/script/values.yaml"
...
helm upgrade "$RELEASE_NAME" prometheus-community/kube-prometheus-stack \
  --version 70.4.2 \
  --namespace monitoring \
  --values /root/sec2025/federation_framework/scenario1/liqo/scenario1/script/values.yaml \
